...
from models.sublayers import FMEmbedding, FMFirstOrderLinear
from preprocess import FeatureSource, FeatureType
...
class ContextRecommender(nn.Module):
    """A base context-aware recommender class. All the context-aware model should implement this class.
    ...
    def __init__(self, config, dataset, embedding_size):
        ...
        self.device = config['device']
        self.double_tower = config['model'] in {'dssm'}
        ...
        # collect feature names and num by user/item
        ...
        # collect feature names and num by feature type
...
class SequentialRecommender(nn.Module):
    """
    A base sequential recommender class. All sequential models should implement this class.
    """
